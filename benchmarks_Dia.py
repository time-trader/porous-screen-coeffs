...
f_ij = np.array([[20, 0, 0], [0, 2, 0], [0, 0, 2]])
...
# Read sweep_results
porous_cfd_1 = pd.read_csv("data/psi_sweep_results_benchmark_dia_fluent.csv", comment='#')
porous_cfd_2 = pd.read_csv("data/psi_sweep_results_benchmark_dia_openfoam.csv", comment='#')
porous_cfd_3 = pd.read_csv("data/psi_sweep_results_benchmark_dia_openfoam_coarse.csv", comment='#')
porous_cfd_2 = porous_cfd_2.iloc[::5]  # too much data, take every 5th row
porous_cfd_3 = porous_cfd_3.iloc[::10]  # too much data, take every 10th row

fx_to_plot = {"2D Analytical": [psi, fx_a],
              "3D Porous CFD FLUENT": [porous_cfd_1['Psi'], porous_cfd_1['Fx']],
              "3D Porous CFD OpenFOAM": [porous_cfd_2['Psi'], porous_cfd_2['Fx']],
              "3D Porous CFD OpenFOAM Coarse": [porous_cfd_3['Psi'], porous_cfd_3['Fx']]}
fy_to_plot = {"2D Analytical": [psi, fy_a],
              "3D Porous CFD FLUENT": [porous_cfd_1['Psi'], porous_cfd_1['Fy']],
              "3D Porous CFD OpenFOAM": [porous_cfd_2['Psi'], porous_cfd_2['Fy']],
              "3D Porous CFD OpenFOAM Coarse": [porous_cfd_3['Psi'], porous_cfd_3['Fy']]}
